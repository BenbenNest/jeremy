...
import com.jeremy.router.core.callback.NavigationCallback;
import com.jeremy.router.core.exception.NoRouteFoundException;
import com.jeremy.router.core.template.IRouteGroup;
import com.jeremy.router.core.template.IRouteRoot;
import com.jeremy.router.core.template.IService;
import com.jeremy.router.core.utils.ClassUtils;
...
public class MyRouter {
    ...
    private static final String ROUTE_ROOT_PAKCAGE = "com.jeremy.router.routes";
    private static final String SDK_NAME = "MyRouter";
    ...
    /**
     * 加载类信息 查找 MyRouter$$Root$$ 类 分组表插入数据
