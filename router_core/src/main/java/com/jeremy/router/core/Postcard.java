...
public class Postcard extends RouteMeta {
    ...
    public Object navigation() {
        return MyRouter.getInstance().navigation(null, this, -1, null);
    }

    public Object navigation(Context context) {
        return MyRouter.getInstance().navigation(context, this, -1, null);
    }
    ...
    public Object navigation(Context context, int requestCode) {
        return MyRouter.getInstance().navigation(context, this, requestCode, null);
    }

    public Object navigation(Context context, int requestCode, NavigationCallback callback) {
        return MyRouter.getInstance().navigation(context, this, requestCode, callback);
    }
