...
/**
 * Created by changqing on 2017/7/31.
 */
...
public class NinePatchUtils {
     ...
     * @throws Exception
     */
    public static NinePatchDrawable decodeDrawableFromAsset(Context context,
                                                            String assetPath) throws Exception {
        Bitmap bitmap = getNinePathchFromAsset(context, assetPath);
...
//            return new BitmapDrawable(bitmap);
     ...
     * @throws Exception
     */
    public static Bitmap getNinePathchFromAsset(Context context,
