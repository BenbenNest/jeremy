...
/**
 * Created by changqing.zhao on 2017/2/5.
 */
...
//        settings.setUserAgentString(ua + "/" + "-Lifestyle-Android"); //设置ua
...
//        super.addJavascriptInterface(new JSObject(), BRIDGE_NAME);
