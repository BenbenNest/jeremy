...
#-keep org.greenrobot.eventbus.annotationprocessor.** { *; }
...
#
## common recyclerview
#-keep class * extends com.qihoo.lianxian.common_recycler_view.view_object.ViewObject { *; }
#-keep class * extends com.qihoo.lianxian.common_recycler_view.adapter_delegate.ViewObjectAdapterDelegate { *; }
#
## gaode map
...
#
## 二维码
#-keep class com.qihoo360.barcode.libs.IBarcodeInfo {*;}
#-keep class com.qihoo360.barcode.libs.IBarcodeDecoder {*;}
#-keep class com.qihoo360.barcode.cloudsafe.p.NetShieldResultProvider {
#    public *;
#}
#-dontwarn com.qihoo360.barcode.libs.**