 ...
 */
public abstract class AdmobAdapter<Adv extends ViewGroup, T, V extends RecyclerView.ViewHolder> extends UltimateViewAdapter<RecyclerView.ViewHolder> {
    ...
    */
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        //   if (parent == null)
        //       Logger.d("getItemCountE2", "parent is null on viewType: " + viewType);
        if (viewType == VIEW_TYPES.ADVIEW) {
            ...
            if (adviewlistener != null) {
                try {
                    ...
                    adview_holder = new AdmobViewHolder(advertise_view);
                } catch (Exception e) {
                    adview_holder = new AdmobViewHolder(advertise_view);
                }
            } else {
    ...
    public int getItemCount() {
        ...
        if (once) {
            ...
            Logger.d("getItemCountE2", check_sum + "");
            return check_sum;
        }
    }
    ...
    public <T> void insert(final List<T> list, final T object, final int first_insert_data_pos) {
        try {
            ...
            Logger.d("admobErrorMr3", e.getMessage());
