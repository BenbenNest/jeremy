...
public class WBUser implements Parcelable {
    ...
    */
    ...
    public WBUser(Parcel in) {
        ...
        following = flags[0];
        allow_all_act_msg = flags[1];
        geo_enabled = flags[2];
        verified = flags[3];
        allow_all_comment = flags[4];
        follow_me = flags[5];
    ...
    public static final Creator<WBUser> CREATOR = new Creator<WBUser>() {
        public WBUser createFromParcel(Parcel in) {
            return new WBUser(in);
        }
