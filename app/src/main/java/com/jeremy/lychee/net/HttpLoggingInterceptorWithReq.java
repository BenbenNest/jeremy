...
public class HttpLoggingInterceptorWithReq implements Interceptor {
    ...
    public HttpLoggingInterceptorWithReq() {
        this(Logger.DEFAULT);
    }

    public HttpLoggingInterceptorWithReq(Logger logger) {
        this.logger = logger;
    }
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        logger.log(response.request().url().encodedPath() + "<-- " + protocol(response.protocol()) + ' ' + response.code() + ' '
