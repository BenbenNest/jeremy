...
public class RetroAdapter {
    public static final String BASE_URL_FORMAL = "http://api.btime.com/";
    public static final String BASE_URL_TEST = "http://10.117.83.51:8080/";
    public static final String BASE_URL_BETA = "http://test.api.btime.com/";

    private static RetroApiService service = null;
    protected static final Object monitor = new Object();
    //    public static String HOST_IOS = "http://cmsapi.kandian.360.cn/";
    public static String HOST_IOS = BASE_URL_FORMAL;
...
//                        .baseUrl("http://10.117.83.51:8001/")
                ...
                service = retrofit.create(RetroApiService.class);
            }
            return service;
        }
    }
