...
class FixedTypeAdapterRuntimeTypeWrapper<T> extends TypeAdapter<T> {
    ...
    public void write(JsonWriter out, T value) throws IOException {
        ...
        if (runtimeType != type) {
            ...
            } else if (!(delegate instanceof com.google.gson.internal.bind.ReflectiveTypeAdapterFactory.Adapter)) {
