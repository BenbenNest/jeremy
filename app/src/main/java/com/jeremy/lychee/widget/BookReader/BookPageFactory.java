    ...
    public void onDraw(Canvas c) {
        ...
        if (m_lines.size() > 0) {
            if (m_book_bg == null) {
                ...
                matrix.postScale((float) mWidth / m_book_bg.getWidth(), (float) mHeight / m_book_bg.getHeight());
                //                c.drawBitmap(m_book_bg, 0, 0, null);
                Rect srcRect = new Rect(0, 0, mWidth, mHeight);
                Rect destRect = new Rect(0, 0, mWidth, mHeight);
//                matrix.setSkew(0.5f, 0);
                Bitmap bitmap = Bitmap.createBitmap(m_book_bg, 0, 0, m_book_bg.getWidth(), m_book_bg.getHeight(), matrix, false);
//                Bitmap bitmap = Bitmap.createBitmap(m_book_bg, 0, 0, mWidth, mHeight);
                c.drawBitmap(bitmap, srcRect, destRect, mPaint);
//                c.drawBitmap(m_book_bg, matrix, mPaint);
