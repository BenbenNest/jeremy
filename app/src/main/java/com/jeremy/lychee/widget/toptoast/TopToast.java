...
public final class TopToast {
    ...
    private TopToast(ViewGroup parent) {
        ...
        mView = (FrameLayout) inflater.inflate(
                com.jeremy.lychee.R.layout.top_toast_layout, mTargetParent, false);
    }
    ...
    public TopToast setText(@NonNull CharSequence message) {
        final TextView tv = ((TopToastLayout)mView.findViewById(com.jeremy.lychee.R.id.top_toast)).getMessageView();
        tv.setText(message);
        return this;
    }
    ...
    final void showView() {
        ...
        ((TopToastLayout)mView.findViewById(com.jeremy.lychee.R.id.top_toast)).setOnAttachStateChangeListener(new TopToastLayout.OnAttachStateChangeListener() {
            @Override
        ...
        if (ViewCompat.isLaidOut(mView)) {
            ...
            ((TopToastLayout)mView.findViewById(com.jeremy.lychee.R.id.top_toast)).setOnLayoutChangeListener(new TopToastLayout.OnLayoutChangeListener() {
                @Override
                public void onLayoutChange(View view, int left, int top, int right, int bottom) {
                    animateViewIn();
                    ((TopToastLayout) mView.findViewById(com.jeremy.lychee.R.id.top_toast)).setOnLayoutChangeListener(null);
                }
            });
        }
    }
    ...
    private void animateViewIn() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
            ...
            ViewCompat.animate(mView)
                    ...
                    .setListener(new ViewPropertyAnimatorListenerAdapter() {
                        ...
                        public void onAnimationStart(View view) {
                            ((TopToastLayout)mView.findViewById(com.jeremy.lychee.R.id.top_toast)).animateChildrenIn(ANIMATION_DURATION - ANIMATION_FADE_DURATION,
            ...
            Animation anim = AnimationUtils.loadAnimation(mView.getContext(),
                    com.jeremy.lychee.R.anim.design_snackbar_in);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
            ViewCompat.animate(mView)
                    ...
                    .setListener(new ViewPropertyAnimatorListenerAdapter() {
                        @Override
                        public void onAnimationStart(View view) {
                            ((TopToastLayout)mView.findViewById(com.jeremy.lychee.R.id.top_toast)).animateChildrenOut(0, ANIMATION_FADE_DURATION);
                        }
            ...
            Animation anim = AnimationUtils.loadAnimation(mView.getContext(), com.jeremy.lychee.R.anim.design_snackbar_out);
            anim.setInterpolator(FAST_OUT_SLOW_IN_INTERPOLATOR);
            anim.setDuration(ANIMATION_DURATION);
            anim.setAnimationListener(new Animation.AnimationListener() {
                @Override
    ...
    public static class TopToastLayout extends LinearLayout {
        ...
        public TopToastLayout(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray a = context.obtainStyledAttributes(attrs, com.jeremy.lychee.R.styleable.SnackbarLayout);
            mMaxWidth = a.getDimensionPixelSize(com.jeremy.lychee.R.styleable.SnackbarLayout_android_maxWidth, -1);
            a.recycle();
            ...
            // the correct Context.
            LayoutInflater.from(context).inflate(com.jeremy.lychee.R.layout.top_toast_layout_include, this);
        ...
        protected void onFinishInflate() {
            ...
            mMessageView = (TextView) findViewById(com.jeremy.lychee.R.id.toast_text);
        }
    ...
    static class ThemeUtils {
        ...
        private static final int[] APPCOMPAT_CHECK_ATTRS = { com.jeremy.lychee.R.attr.colorPrimary };
