package com.jeremy.demo.camera;
...
import com.jeremy.library.utils.DisplayUtils;
...
//        viewHeight = panelHeght - (int) DisplayUtil.dp2px(activity,TOP_BAR_HEIGHT + BOTTOM_BTN_HEIGHT);
        ...
        rectWidth = panelWidth - (int) DisplayUtils.dp2px(activity, LEFT_PADDING + RIGHT_PADDING);
